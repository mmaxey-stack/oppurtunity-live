...
type PremiumHomeDashboardProps = {
...
export function PremiumHomeDashboard({
  ...
  const heroLine =
    role === "business"
      ? "Promote this deal and convert local traffic with athlete creators."
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="max-w-xl text-sm text-slate-300 sm:text-base">{heroLine}</p>
            </div>
